 ...
 * FILE:   RosterPanel.tsx (CoreZenith V3 - Syntax Fixed)
 * =================================================================
 * DESCRIPTION: Fixed version with proper syntax and 100% functional integrity
 */
                ...
                <div className="flex-shrink-0">
                    ...
                    <CardContent className="px-2 space-y-1">
                        <Button 
                            ...
                            variant="ghost" 
                            className={cn(
                                'w-full justify-start p-3 transition-colors', 
                                viewingMode === 'teacher' 
                                ...
                                return (
                                    <div 
                                        ...
                                        className={cn(
                                            ...
                                            hasHandRaised && 'bg-fuchsia-800/20 border-fuchsia-700/50 animate-pulse', 
                                            isViewingThisStudent && 'bg-slate-800/50'
                                        )}
                                    >
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Button 
                                                ...
                                                variant='ghost' 
                                                className={cn(
                                                    'flex-grow justify-start text-left h-auto py-2 px-2 hover:bg-slate-800', 
                                                    isViewingThisStudent && 'bg-cyan-500/10'
                                                )}
                                            >
                                                <div className="flex items-center">
                                                    ...
                                                    <span className={cn(
                                                        'font-semibold', 
                                                        isViewingThisStudent ? 'text-cyan-300' : 'text-slate-200'
                                                    )}>
                                                        {student.username}
                                                    </span>
                                                </div>
                                                {activeHomeworkStudents.has(student.id) && (
                                                    <Badge className="ml-2 bg-green-500/80 border-none text-white text-xs px-1.5 py-0.5">
                                                        Live
                                                    </Badge>
                                                )}
                                            </Button>
                                            ...
                                            <div className="flex items-center gap-1">
                                                <Button 
                                                    variant="ghost" 
                                                    size="icon" 
                                                    className="h-8 w-8 text-slate-400 hover:bg-slate-700 hover:text-cyan-300 relative" 
                                                ...
                                                <Button 
                                                    variant={isSpotlighted ? "secondary" : "ghost"} 
                                                    size="icon" 
                                                    className={cn(
                                                        'h-8 w-8 text-slate-400 hover:bg-slate-700', 
                                                        isSpotlighted && 'bg-fuchsia-500/20 text-fuchsia-300'
                                                    )} 
                                        ...
                                        {/* Extended Actions for Viewed Student */}
                                            ...
                                            <div className="border-t border-slate-700 mt-2 pt-2 space-y-1">
                                                {availableLessons.length > 0 ? (
                                                    ...
                                                    <p className="text-xs text-slate-500 text-center p-2">
                                                        No available lessons to assign.
                                                    </p>
                                                )}
                                            </div>
                                        )}
                ...
                <Card className="flex-grow flex flex-col bg-transparent border-none shadow-none">
                    ...
                    <CardContent className="p-0 flex-grow">
                        <div className="bg-black rounded-lg aspect-video flex items-center justify-center w-full h-full">
                            ...
                            />
                            {!remoteStream && (
                                <span className="text-xs text-slate-500">Signal Offline</span>
                            )}
                        </div>
                    </CardContent>
                </Card>
            ...
            <div className="flex-shrink-0">
                ...
                <div className="flex justify-center items-center space-x-3 pt-3">
                    <Button 
                        ...
                        onClick={toggleMute} 
                        className={cn(
                            'rounded-full h-12 w-12 bg-slate-800/50 border-slate-700 hover:bg-slate-700', 
                            isMuted && 'bg-red-600/80 border-red-500 text-white hover:bg-red-500'
                        )}
                    >
                        {isMuted ? <MicOff /> : <Mic />}
                    </Button>
                    <Button 
                        ...
                        className={cn(
                            'rounded-full h-12 w-12 bg-slate-800/50 border-slate-700 hover:bg-slate-700', 
                            isCameraOff && 'bg-red-600/80 border-red-500 text-white hover:bg-red-500'
                        )}
                    >
