        ...
        if (currentPath.includes('/leetcode')) {
            return [
                ...
                },
                {
                    ...
                    description: 'Easy - Sliding Window',
                    icon: Code,
                    path: '/leetcode/ide/121',
                    priority: 'medium',
                    category: 'build',
                    canBeGoal: true
                },
                {
                    ...
                    description: 'View all 150+ LeetCode problems',
                    icon: Target,
                    path: '/leetcode/browse',
                    priority: 'high',
                    category: 'build'
                },
                {
                    id: 'nav-2',
                    title: 'View LeetCode Courses',
