...
// [ADDITIVE] Added icons for the new features while keeping all original icons.
...
// [ADDITIVE] The CourseLesson type is enhanced to include `lesson_type`.
// This is essential for rendering the correct icon in the course blueprint.
...
const CourseEditorPage: React.FC = () => {
    ...
    // State management is identical to the MVP.
    ...
    // --- DATA FETCHING (Identical to MVP) ---
    ...
    // handling loading, success, and error states gracefully without buggy optimistic updates.
    const handleRemoveLesson = async (lessonIdToRemove: string) => {
        const lessonToRemove = courseLessons.find(l => l.id === lessonIdToRemove);
        toast.promise(
            apiClient.delete(`/api/lessons/${lessonIdToRemove}`),
            {
    ...
    // [ADDITIVE] New handler to navigate to the dedicated chapter creation page.
        ...
        <div className="w-full min-h-screen bg-[#0a091a] text-white font-sans">
            ...
            <div className="container mx-auto p-4 sm:p-6 lg:p-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    {/* The Library Card is 100% identical to the MVP to guarantee its functionality. */}
                    <GlassCard>
                        <CardHeader>
                    ...
                    <GlassCard>
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                ...
                                {/* [ADDITIVE] The "Create New" button is replaced with more specific actions. */}
                            ...
                            <CardDescription>Review and arrange the chapters and lessons in your course.</CardDescription>
                        </CardHeader>
                        <CardContent className="flex-grow max-h-[60vh] overflow-y-auto pr-3">
                            ...
                            {courseLessons.length === 0 && <div className="text-center py-16 border-2 border-dashed border-slate-700 rounded-xl"><p className="text-slate-400">Your course is empty.</p><p className="text-sm text-slate-500 mt-1">Add items from the library or create new content to begin.</p></div>}
                        </CardContent>
                    </GlassCard>
                </div>
            </div>
